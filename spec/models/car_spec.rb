...
RSpec.describe Car, type: :model do
    before(:each) do
        @user = User.new(id: 4, name: 'Robert', username: 'roby',email: 'robert@gmail.com', password: 'secret123')
        @car = Car.create(user: @user, model: 'Ford', make: 'Some', image: 'photo.jpg', color: 'red', seat: 4, year: 2019, engine: 'automatic', aircon: 'false', price: '18.00', description: 'some')
    end
